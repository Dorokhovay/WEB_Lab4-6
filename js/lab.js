...
const correctAnswers = {
  ...
  let points = 0;
  // Отримання за посилання на елементи
  ...
  // За допомогою циклів for if перебираємо елементи і їхні значення value, які записуємо у масив відповідей користувача
    ...
    modalTextRef.innerHTML = `Користувачу, ${userNameRef.value}, з групи ${userGroupRef.value}, ваш бал за тест ${points}.`;
    // Обнуляємо значення.
    points = 0;
    userAnswers = [];
  });